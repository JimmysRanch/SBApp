      ...
      try {
        ...
        const [staffResp, serviceResp, sizeResp, addOnResp, apptResp] = await Promise.all([
          ...
          supabase
            .from("appointments")
            .select(
              "id,employee_id,service_id,service_size_id,start_time,end_time,discount,tax,status,notes,client:clients(*),pet:pets(*)"
            )
        ...
        const appointmentRows = (apptResp.data ?? []) as any[];
