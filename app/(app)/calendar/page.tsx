  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        let appointmentResp = await runAppointmentQuery(appointmentColumnsWithSize);
        if (appointmentResp.error && isMissingColumnError(appointmentResp.error, "service_size_id")) {
        ...
        if (appointmentResp.error) throw appointmentResp.error;

        const appointmentRows = (appointmentResp.data ?? []) as any[];
