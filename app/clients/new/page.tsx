            ...
            <div className="space-y-4">
              {dogs.map((dog, index) => (
                ...
                >
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    <div className="space-y-1.5">
                      <label className={labelClass} htmlFor={`dog-age-${index}`}>
                        Age <span className="font-normal text-brand-navy/60">(optional)</span>
                      </label>
                      <input
                        id={`dog-age-${index}`}
                        type="text"
                    ...
                    <div className="space-y-1.5">
                      <label className={labelClass} htmlFor={`dog-weight-${index}`}>
                        Weight <span className="font-normal text-brand-navy/60">(optional)</span>
                      </label>
                      <input
                        id={`dog-weight-${index}`}
                        type="text"
                    ...
                    <div className="space-y-1.5 md:col-span-3">
                      <label className={labelClass} htmlFor={`dog-hair-${index}`}>
                        Coat / hair type <span className="font-normal text-brand-navy/60">(optional)</span>
                      </label>
                      <input
                        id={`dog-hair-${index}`}
                        type="text"
                  ...
                  <div className="grid gap-3 md:grid-cols-[minmax(0,0.6fr)_minmax(0,1fr)] md:items-end">
